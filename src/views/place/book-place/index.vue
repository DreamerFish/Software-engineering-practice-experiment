      ...
      <a-card class="general-card">
        ...
        <div class="wrapper">
          ...
          <keep-alive>
            ...
            <ChannelInfo v-else-if="step === 2" @change-step="changeStep" :sId="((route.query.id) as string)" />
...
import { insertReservation } from '@/network/module/place';
...
const submitForm = async () => {
  setLoading(true);
  try {
    const { code, message } = await insertReservation(submitModel.value);
    if (code === 20000) {
      step.value = 3;
